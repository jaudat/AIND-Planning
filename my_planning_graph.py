...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if action_node.prenodes.issubset( s_level ):
                action_node.parents = set(node for node in s_level if node in action_node.prenodes)
                for action_node_parent in action_node.parents:
                    action_node_parent.children.add(action_node)
                nodelist.append(action_node)

        self.a_levels.append( set(nodelist) )
    ...
    def add_literal_level(self, level):
        ...
        a_nodes_at_previous_level = self.a_levels[level-1]

        self.s_levels.append(set())
        for action_node in a_nodes_at_previous_level:
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return a1_add.intersection(a2_rem) or a1_rem.intersection(a2_add)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return a1_add.intersection(a2_neg) or a1_rem.intersection(a2_pos) or a1_pos.intersection(a2_rem) or a1_neg.intersection(a2_add)
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        allMutex = True
        for action_to_achieve_s1 in node_s1.parents:
            for action_to_achieve_s2 in node_s2.parents:
                if not action_to_achieve_s1.is_mutex(action_to_achieve_s2):
                    allMutex = False
        return allMutex
